...
import com.julius.mytube.databinding.ItemHomeVideoMiddleBinding
import com.julius.mytube.extends.inflate
import com.julius.mytube.models.home.VideoInfo
import java.text.SimpleDateFormat
import java.util.*

class ItemHomeVideoMiddleViewHolder(
    parent: ViewGroup,
    val binding: ItemHomeVideoMiddleBinding = parent.inflate(attach = false)
